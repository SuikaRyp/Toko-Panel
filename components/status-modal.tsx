    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative z-50 w-full max-w-md overflow-hidden rounded-2xl premium-card shadow-2xl border border-white/10"
        >
          <div
            className={`p-5 ${
              type === "success"
          ...
          <div className="p-5">
            ...
            {panelDetails && (
              <div className="mb-5 rounded-xl bg-white/[0.04] p-4 border border-white/10">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="bg-black/20 px-3 py-2 rounded-lg border border-white/5 text-gray-300 text-sm font-mono break-all">
                  ...
                  <div>
                    ...
                    <div className="bg-black/20 px-3 py-2 rounded-lg border border-white/5 text-gray-300 text-sm font-mono">

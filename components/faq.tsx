...
function FAQItem({
  ...
  return (
    <div
      className={`bg-white/[0.035] backdrop-blur-xl border ${
        isOpen ? "border-violet-400/40 shadow-lg shadow-violet-950/20" : "border-white/10 hover:border-white/20"
...
export function FaqSection() {
  ...
  return (
  <section id="faq" className="py-20 section-surface border-t border-white/5">

  ...
  return (
    ...
    >
      <Card className="premium-card overflow-hidden">
        <div className="bg-gradient-to-r from-violet-600/90 via-fuchsia-600/80 to-cyan-500/80 text-white p-4">
          ...
          <div className="p-5 border-b border-white/10 flex flex-col md:flex-row justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="font-mono text-sm bg-black/20 px-2 py-1.5 rounded-lg border border-white/10 text-gray-200">
                  {transactionId}
                </p>
              </div>
            </div>
          ...
          <div className="p-5 border-b border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                <div className="p-2 icon-shell rounded-xl mt-1">
          ...
          <div className="p-5">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between font-medium">
                ...
                <span className="text-xl text-cyan-300">{formatRupiah(total)}</span>
              </div>
            </div>
          </div>
        </CardContent>

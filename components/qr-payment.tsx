              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 space-y-6">
                  <div className="bg-white/[0.04] p-4 rounded-xl border border-white/10">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between font-medium">
                        ...
                        <span className="text-cyan-300">{formatRupiah(total)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <Button
                    onClick={checkStatus}
                    disabled={isChecking}
                    className="w-full h-12 flex items-center justify-center premium-button"
                  >
                    {isChecking ? (
                      <>
        ...
        >
          <Card className="overflow-hidden border-dark-300 bg-dark-400">
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-white/[0.04] p-4 rounded-xl border border-white/10 mb-4">

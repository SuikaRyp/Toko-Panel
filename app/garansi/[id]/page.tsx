...
export default function GaransiDetailPage() {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-6 sm:p-8 premium-card rounded-3xl">
      <motion.h1
      ...
      <Card className="bg-white/[0.035] border-white/10 mb-5">
      ...
      {!panelData ? (
        <div className="space-y-4">
          ...
          <Button
            ...
            className="w-full h-14 premium-button text-lg font-semibold"
            disabled={verifying || locked}
          >
            {verifying ? (
              <>
        ...
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="bg-white/[0.035] border border-white/10 p-5 rounded-2xl space-y-3 mt-4"
        >
          <h3 className="font-semibold text-white flex items-center gap-2">
            <Server className="w-4 h-4 text-violet-400" /> Panel Baru Dibuat
          </h3>

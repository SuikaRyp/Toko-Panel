    ...
    <div className="min-h-screen theme-shell">
      ...
      <div className="container mx-auto px-4 py-24">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <Link href="/" className="inline-flex items-center text-gray-400 hover:text-cyan-300 mb-4">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {transactions.map((transaction) => (
                <Card key={transaction.transactionId} className="premium-card overflow-hidden">
                  <div
                  ...
                  <CardContent className="p-4">
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        <div className="p-2 icon-shell rounded-xl">
                      ...
                      <div className="mt-4 pt-4 border-t border-dark-300 flex justify-between items-center">
                        <span className="text-cyan-300 font-medium">{formatRupiah(transaction.total)}</span>
                        <Button
                          variant="outline"
                          size="sm"
      ...
      {showDetails && selectedTransaction && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="relative w-full max-w-2xl premium-card rounded-2xl shadow-2xl overflow-hidden">
            <div
              className={`p-4 ${
            ...
            <div className="p-6">
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white/[0.04] p-4 rounded-xl border border-white/10">
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-medium text-cyan-300">{formatRupiah(selectedTransaction.total)}</p>
                    </div>
                    <div>
                    ...
                    <div className="bg-white/[0.04] p-4 rounded-xl border border-white/10">
                      <div className="space-y-3">
                        <div>
                          ...
                          <div className="bg-black/20 px-3 py-2 rounded-lg border border-white/5 text-gray-200 text-sm font-mono break-all">
                        ...
                        <div>
                          ...
                          <div className="bg-black/20 px-3 py-2 rounded-lg border border-white/5 text-gray-200 text-sm font-mono">
                ...
                <div className="flex justify-end">
                  <Button onClick={handleCloseDetails} className="premium-button">
                    Tutup
                  </Button>
                </div>
              </div>
